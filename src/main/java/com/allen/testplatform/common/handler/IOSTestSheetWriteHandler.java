...
import com.allen.testplatform.testscripts.enums.IOSActionTypeEnum;
...
public class IOSTestSheetWriteHandler implements SheetWriteHandler {
    ...
    public void afterSheetCreate(WriteWorkbookHolder writeWorkbookHolder, WriteSheetHolder writeSheetHolder) {
        ...
        List<String> actionKeywords = IOSActionTypeEnum.getAllKeyword();
        List<String> actionDescriptions = IOSActionTypeEnum.getAllDescription();
