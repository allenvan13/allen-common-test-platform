...
/**
 * IOS端APP测试基类 <br>
 * 使用方法与{@link AndroidTestBase}一致
 * @author Fan QingChuan
 * @since 2022/7/4 17:42
 */

public class IOSTestBase extends AppTestBase implements IOSCommon {

    private static final ReportLog reportLog = new ReportLog(IOSTestBase.class);
