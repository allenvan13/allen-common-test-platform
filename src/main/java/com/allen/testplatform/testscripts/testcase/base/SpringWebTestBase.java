...
import com.allen.testplatform.testscripts.testcase.demo.WebAndSpringTestDemo;
...
/**
 * Web & Spring环境测试基类 <br>
 * 功能包含 {@link WebTestBase} ,且在此基础上添加启动Spring容器 示例: <br>
 * {@link WebAndSpringTestDemo} <br>
...
public abstract class SpringWebTestBase extends AbstractTestNGSpringContextTests implements TestCommon, WebCommon{

    public static final int TIME_OUT = 10;
    public static final int SLEEP_TIME = 300;
    private static final ReportLog reportLog = new ReportLog(SpringWebTestBase.class);
     ...
     * 另需注意openBrowser(初始化打开浏览器)操作属特殊情况,不能传入WebDriver,因为在正常情况下,openBrowser前WebDriver为null没初始化,
     * 当然就不存在上文WebDriver
     *
     * @param caseVoList 解析后的测试用例List  {@link TestCaseVo}
    ...
    private void invokeMethod(Class<?> clazz, Object instance, WebDriver driver, String actionKeyword, String elementLocateType, String elementLocateValue, String parameter) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
