...
public class ZsjcMainProcessTest extends CommonCheck {

    private static final ReportLog reportLog = new ReportLog(ZsjcMainProcessTest.class);
    ...
    void initData() {
        CheckTypeEnum checkType = CheckTypeEnum.getCheckType(Constant.ZSJC);
