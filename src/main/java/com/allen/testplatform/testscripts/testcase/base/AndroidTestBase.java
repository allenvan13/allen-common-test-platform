 ...
 * {@link com.allen.testplatform.testscripts.testcase.demo.JxAppLoginTestDemo} <br>
 * {@link com.allen.testplatform.testscripts.testcase.demo.JxWithLocalServiceTestDemo} <br>
 * {@link com.allen.testplatform.testscripts.testcase.demo.JxAndroidSummaryTestDemo} <br>
 * = 同样提供Excel执行方式 示例 <br>
 * {@link com.allen.testplatform.testscripts.testcase.demo.ExcelAndroidTestDemo} <br>
 * = 同时进行 Web与App测试 示例 <br>
 * {@link com.allen.testplatform.testscripts.testcase.demo.WebAndAppTestDemo} <br>
