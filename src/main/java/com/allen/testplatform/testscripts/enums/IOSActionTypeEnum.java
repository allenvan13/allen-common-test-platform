...
public enum IOSActionTypeEnum {
    ...
    public static IOSActionTypeEnum getTargetType(String actionKeyword) {
        for (IOSActionTypeEnum value : IOSActionTypeEnum.values()) {
    ...
    public static List<String> getAllKeyword() {
        return Arrays.stream(IOSActionTypeEnum.values()).map(IOSActionTypeEnum::getActionKeyword).collect(Collectors.toList());
    }

    public static List<String> getAllDescription() {
        return Arrays.stream(IOSActionTypeEnum.values()).map(IOSActionTypeEnum::getDescription).collect(Collectors.toList());
    }
}
